...
class CardAdapter(
    ...
    private val itemList:MutableList<CardItem> = mutableListOf() ,
    ...
    override fun onBindViewHolder(holder: CardViewHolder, position: Int) {
        ...
        with(holder.binding) {
            if (item.images.isNotEmpty()) {
                ...
                holder.binding.itemImage.setImageResource(R.drawable.ic_image_placeholder) // صورة افتراضية
            }
        ...
        holder.binding.root.setOnClickListener {
            ...
            Log.e("CardAdapter", "ownerId=${item.ownerId}, requesterId=$requesterId")
